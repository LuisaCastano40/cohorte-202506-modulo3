...
import { HttpClient } from '@angular/common/http'; //par apoder usar GET, POST, PUT, DELETE
...
export class ProductService {
  ...
  putProduct(productToUpdate: Product, id:string){
    // return this._httpClient.put(this.apiUrl + '/products/actualizar/' + id, productToUpdate); //OPCION1
    return this._httpClient.put(`${this.apiUrl}/products/actualizar/${id}`, productToUpdate); //OPCIÓN2
  };
